...
class ServiceLoaderRegistrationTest : StringSpec({
    "DelphixRemoteServer is discoverable as a dev.dit.remote.RemoteServer ServiceLoader provider" {
        ServiceLoader.load(RemoteServer::class.java).any { it is DelphixRemoteServer } shouldBe true
    }
})
